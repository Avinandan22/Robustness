...
where  <LaTeX formula='z' inline={true}/> denotes the current datapoint or batch of datapoints.

Some of the data points may be poisoned by an adversary who wants to mislead the learning algorithm towards parameters that optimize some adversarial objective 

<LaTeX formula='\ell_{\text{adv}}(\theta)'/>
