...
## The Problem Setup
We assume that our learning algorithm is trying to estimate a set of parameters <LaTex formula='\theta' /> (like the parameters of a neural network). The algorithm updates its estimate of θ with every new data point it receives.
