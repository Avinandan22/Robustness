...
We study online learning algorithms of the form <Latex>\theta^\prime \gets F(\theta, z)</Latex> where $\theta$ are the model parameters being estimated and $z$ denotes the current datapoint or batch of datapoints.
