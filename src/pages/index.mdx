...
We study online learning algorithms of the form $$\theta^\prime \gets F(\theta, z)$$ where $\theta$ are the model parameters being estimated and $z$ denotes the current datapoint or batch of datapoints.
